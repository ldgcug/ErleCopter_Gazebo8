...
void GazeboOdometryPlugin::Load(physics::ModelPtr _model, sdf::ElementPtr _sdf) {
  ...
  math::Vector3 noise_normal_position;
  math::Vector3 noise_normal_quaternion;
  math::Vector3 noise_normal_linear_velocity;
  math::Vector3 noise_normal_angular_velocity;
  math::Vector3 noise_uniform_position;
  math::Vector3 noise_uniform_quaternion;
  math::Vector3 noise_uniform_linear_velocity;
  math::Vector3 noise_uniform_angular_velocity;
  const math::Vector3 zeros3(0.0, 0.0, 0.0);
  ...
  getSdfParam<math::Vector3>(_sdf, "noiseNormalPosition", noise_normal_position, zeros3);
  getSdfParam<math::Vector3>(_sdf, "noiseNormalQuaternion", noise_normal_quaternion, zeros3);
  getSdfParam<math::Vector3>(_sdf, "noiseNormalLinearVelocity", noise_normal_linear_velocity, zeros3);
  getSdfParam<math::Vector3>(_sdf, "noiseNormalAngularVelocity", noise_normal_angular_velocity, zeros3);
  getSdfParam<math::Vector3>(_sdf, "noiseUniformPosition", noise_uniform_position, zeros3);
  getSdfParam<math::Vector3>(_sdf, "noiseUniformQuaternion", noise_uniform_quaternion, zeros3);
  getSdfParam<math::Vector3>(_sdf, "noiseUniformLinearVelocity", noise_uniform_linear_velocity, zeros3);
  getSdfParam<math::Vector3>(_sdf, "noiseUniformAngularVelocity", noise_uniform_angular_velocity, zeros3);
